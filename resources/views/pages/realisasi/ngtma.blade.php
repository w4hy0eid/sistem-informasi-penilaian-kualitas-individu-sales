                    ...
                    <table class="table" id="table-dbs">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <button type="button" class="btn btn-sm btn-info" onclick="updateNgtma('{{ $sustain['user_id'] }}', '{{ $sustain['sales_id'] }}')" data-bs-toggle="modal" data-bs-target="#table-list">Detail</button>
                                </td>
                            </tr>
                            @php
                            $no++;
