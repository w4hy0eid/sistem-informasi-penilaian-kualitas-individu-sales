        ...
        <div class="tab-content">
            <div class="tab-pane fade" id="dbs" role="tabpanel" aria-labelledby="dbs-tab">
                <form action="{{ route('/action/export-realisasi') }}" method="post">
                    <input type="hidden" name="type" value="sustain">
                    ...
                    <table class="table" id="table-dbs">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <button type="button" class="btn btn-sm btn-info" onclick="updateSustain('{{ $sustain['user_id'] }}', '{{ $sustain['sales_id'] }}')" data-bs-toggle="modal" data-bs-target="#table-list">Detail</button>
                                </td>
                            </tr>
                            @php
                            $no++;
