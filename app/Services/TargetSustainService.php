...
class TargetSustainService
{
    ...
    public function list()
    {
        ...
        if (str_contains($tr, 'TR')) {
            $resultTreg = TargetSustain::whereHas('users', function (Builder $query) use ($user_id, $role) {
            ...
            $resultDbs = TargetSustain::whereHas('users', function (Builder $query) use ($user_id, $role) {
    ...
    {
        $result = TargetSustain::where('id', $idUser)->first();
