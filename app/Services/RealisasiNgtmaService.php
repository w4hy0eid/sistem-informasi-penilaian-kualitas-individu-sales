...
class RealisasiNgtmaService
{
    ...
    {
        $sustain = RealisasiNgtma::find($id);
    ...
    {
        $result = RealisasiNgtma::where('user_id', $userId)->where("sales_id", $salesId)->get();
    ...
    {
        $result = RealisasiNgtma::where('id', $idUser)->first();
