...
use App\Services\TargetSustainService;

class TargetSustainController extends Controller
{
    public function __construct(private TargetSustainService $targetService)
    {
    ...
    public function index() {
        ...
        return view("pages.target.sustain", ["js" => url("/js/target/sustain.js"), "data" => $data]);
    }
